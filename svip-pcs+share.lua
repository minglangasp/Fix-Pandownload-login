...
function onInitTask(task, user, file)
    if task:getType() ~= TASK_TYPE_BAIDU then
		...
		table.insert(header, "Cookie: BDUSS=tpZngxc3A2ZkYtRlVBSEpZR2R4fnFMb0JJNDU0dGxoYlJ2eGUzUUpzNWNHeDFmRVFBQUFBJCQAAAAAAQAAAAEAAADRskQdwv7A8jg2MDIwNQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFyO9V5cjvVeNE")
